    ...
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h2 className="font-display text-3xl italic text-ink">Join Inkspace</h2>
          <p className="mt-2 text-sm text-taupe">A quieter place to publish your writing.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="name" className="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-taupe">
              Name
            </label>
            <input
              type="text"
        ...
        <p className="mt-8 text-center text-sm text-taupe">
          ...
          <Link to="/login" className="link-underline font-medium text-maroon">
            Sign in
          </Link>
        </p>
      </motion.div>
